...
// Returns the private 'App\Repository\FoundDirtRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FoundDirtRepository.php';

return $this->privates['App\\Repository\\FoundDirtRepository'] = new \App\Repository\FoundDirtRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
