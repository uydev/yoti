...
// Returns the private 'App\Repository\DirtCoordinatesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DirtCoordinatesRepository.php';

return $this->privates['App\\Repository\\DirtCoordinatesRepository'] = new \App\Repository\DirtCoordinatesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
