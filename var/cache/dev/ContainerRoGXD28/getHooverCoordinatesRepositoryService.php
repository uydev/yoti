...
// Returns the private 'App\Repository\HooverCoordinatesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HooverCoordinatesRepository.php';

return $this->privates['App\\Repository\\HooverCoordinatesRepository'] = new \App\Repository\HooverCoordinatesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
